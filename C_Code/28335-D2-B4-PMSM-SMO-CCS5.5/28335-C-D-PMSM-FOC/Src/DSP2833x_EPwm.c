...
void  QEP_Init(void)
{
	...
	EQep1Regs.QDECCTL.bit.QSRC=00;		// QEP 正交模式 
		
	EQep1Regs.QEPCTL.bit.FREE_SOFT=2;//自由运行
	EQep1Regs.QEPCTL.bit.PCRM=0;		// PCRM=00 mode - QPOSCNT reset on index event
	EQep1Regs.QEPCTL.bit.UTE=1; 		// Unit Timeout Enable 允许时钟
	EQep1Regs.QEPCTL.bit.QCLM=1; 		// Latch on unit time out
	EQep1Regs.QPOSMAX=0xfa0;           // 2500Lines * 4 = 10000 pulses= ox2710 pulses 现在是1000线
