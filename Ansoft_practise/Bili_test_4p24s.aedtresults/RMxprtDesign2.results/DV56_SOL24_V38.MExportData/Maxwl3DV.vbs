...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "163.2736950185148mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "Hs2", "Value:=", "6.694975363156209mm"), Array("NAME:Pair", _
  "Name:=", "Bs0", "Value:=", "2.5mm"), Array("NAME:Pair", "Name:=", "Bs1", _
  "Value:=", "5.650058243610945mm"), Array("NAME:Pair", "Name:=", "Bs2", _
  "Value:=", "7.41287869930214mm"), Array("NAME:Pair", "Name:=", "Rs", _
  "Value:=", "3.70643934965107mm"), Array("NAME:Pair", "Name:=", "FilletType", _
  "Value:=", "0"), Array("NAME:Pair", "Name:=", "HalfSlot", "Value:=", "0"), _
  Array("NAME:Pair", "Name:=", "SegAngle", "Value:=", "30deg"), Array(_
  "NAME:Pair", "Name:=", "LenRegion", "Value:=", "163.2736950185148mm"), _
  ...
  "MaterialName:=", "DW310_35_3DSF0.950", "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "6.694975363156209mm"), _
  Array("NAME:Pair", "Name:=", "Bs0", "Value:=", "2.5mm"), Array("NAME:Pair", _
  "Name:=", "Bs1", "Value:=", "5.650058243610945mm"), Array("NAME:Pair", _
  "Name:=", "Bs2", "Value:=", "7.41287869930214mm"), Array("NAME:Pair", _
  "Name:=", "Rs", "Value:=", "3.70643934965107mm"), Array("NAME:Pair", _
  ...
  "Name:=", "LenRegion", "Value:=", "163.2736950185148mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "ThickMag", "Value:=", "3.3mm"), Array("NAME:Pair", "Name:=", "WidthMag", _
  ...
  "LenRegion", "Value:=", "163.2736950185148mm"), Array("NAME:Pair", "Name:=", _
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "1500rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000767684, _
  "Load Torque:=", _
  "if(speed<157.08, -0.022309*speed, -550.453/speed) - 0.022309*(speed-157.08)*10", _
  "Objects:=", Array("Band"))
