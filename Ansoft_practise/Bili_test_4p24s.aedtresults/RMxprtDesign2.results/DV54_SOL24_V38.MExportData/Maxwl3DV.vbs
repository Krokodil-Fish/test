...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "163.2735715572084mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "Hs2", "Value:=", "6.694896487764112mm"), Array("NAME:Pair", _
  "Name:=", "Bs0", "Value:=", "2.5mm"), Array("NAME:Pair", "Name:=", "Bs1", _
  "Value:=", "5.650058243610945mm"), Array("NAME:Pair", "Name:=", "Bs2", _
  "Value:=", "7.412857931017404mm"), Array("NAME:Pair", "Name:=", "Rs", _
  "Value:=", "3.706428965508702mm"), Array("NAME:Pair", "Name:=", _
  ...
  "163.2735715572084mm"), Array("NAME:Pair", "Name:=", "InfoCore", "Value:=", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "6.694896487764112mm"), _
  Array("NAME:Pair", "Name:=", "Bs0", "Value:=", "2.5mm"), Array("NAME:Pair", _
  "Name:=", "Bs1", "Value:=", "5.650058243610945mm"), Array("NAME:Pair", _
  "Name:=", "Bs2", "Value:=", "7.412857931017404mm"), Array("NAME:Pair", _
  "Name:=", "Rs", "Value:=", "3.706428965508702mm"), Array("NAME:Pair", _
  ...
  "Name:=", "LenRegion", "Value:=", "163.2735715572084mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "ThickMag", "Value:=", "2.9mm"), Array("NAME:Pair", "Name:=", "WidthMag", _
  ...
  "LenRegion", "Value:=", "163.2735715572084mm"), Array("NAME:Pair", "Name:=", _
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "1500rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000759824, _
  "Load Torque:=", _
  "if(speed<157.08, -0.0223077*speed, -550.42/speed) - 0.0223077*(speed-157.08)*10", _
  "Objects:=", Array("Band"))
