...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "Load Torque:=", _
  "if(speed<157.08, -0.022319*speed, -550.7/speed) - 0.022319*(speed-157.08)*10", _
  "Objects:=", Array("Band"))
