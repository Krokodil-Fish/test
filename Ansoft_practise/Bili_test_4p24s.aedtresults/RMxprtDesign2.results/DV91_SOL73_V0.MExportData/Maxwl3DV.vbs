...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "Load Torque:=", _
  "if(speed<157.08, -0.0223167*speed, -550.643/speed) - 0.0223167*(speed-157.08)*10", _
  "Objects:=", Array("Band"))
