...
void InitGpio(void)
{
   ...
   GpioCtrlRegs.GPCMUX1.bit.GPIO78=0;//设置为GPIO W
   GpioCtrlRegs.GPCMUX1.bit.GPIO77=0;//设置为GPIO V
   GpioCtrlRegs.GPCMUX1.bit.GPIO76=0;//设置为GPIO U
   ...
   GpioCtrlRegs.GPCDIR.bit.GPIO78=0;//输入 W
   GpioCtrlRegs.GPCDIR.bit.GPIO77=0;//输入 V
   GpioCtrlRegs.GPCDIR.bit.GPIO76=0;//输入 U
